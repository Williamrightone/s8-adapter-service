...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void receiveTransactionInfo(TransactionInfo transactionInfo) {
        ...
        String[] currencyCodeParts = transactionEntity.getCurrencyCode().split("\\s+");
        if (currencyCodeParts.length != 2) {
            throw new IllegalArgumentException("Invalid currency string: " + transactionEntity.getCurrencyCode());
        }
        ...
        transactionEntity.setValueDate(transactionInfo.getValueDate());
